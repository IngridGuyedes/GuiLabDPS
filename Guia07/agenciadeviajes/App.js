    ...
    <View style={styles.vistaModal}>
      <View style={styles.Modal}>
        ...
        <View style={styles.contenedor}>
          <Text styles={styles.titulo}>¿Que hacer en El Salvador?</Text>
            ...
            <View>
              <View>
                <Image
                  ...
                  source={requiere('./src/img/mejores1.jpg')} />
              </View>

              <Image
                style={styles.mejores}
                source={requiere('./src/img/mejores2.jpg')} />
            </View>

            <Image
              style={styles.mejores}
              source={requiere('./src/img/mejores3.jpg')} />
          </View>
        </View>
